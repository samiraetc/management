...
import { DropdownButton, DropdownCategoryTitle } from '@/components/ui/dropdown-button'
...
export type ContentPickerOptions = Array<ListTypePickerOption | ListTypePickerCategory>

export type ListTypePickerProps = {
  options: ContentPickerOptions
}

const isOption = (option: ListTypePickerOption | ListTypePickerCategory): option is ListTypePickerOption =>
  option.type === 'option'
const isCategory = (option: ListTypePickerOption | ListTypePickerCategory): option is ListTypePickerCategory =>
  ...
  return (
    <Dropdown.Root>
      <Dropdown.Trigger asChild>
        <Toolbar.Button active={activeItem?.id !== 'bulletList' && !!activeItem?.type}>
          <Icon name={(activeItem?.type === 'option' && activeItem.icon) || 'List'} />
